...
gcc -g -O0 -Wall -Wextra -ffp-contract=off -DDEBUG $SAN $INC harness.c -o of_dbg  $RL $FW -lm
gcc -g -O0 -Wall -Wextra -ffp-contract=off         $SAN $INC drive_test.c -o drive  $RL $FW -lm
gcc -O2 -Wall -Wextra -ffp-contract=off                 $INC harness.c -o of_fast $RL $FW -lm
